...
public class VinkiModModule : EverestModule {
    ...
    public static int[][][] artSpots = [//x,y,w,h,textureNamespaces directory
        ...
        [[1812,-238,32,48,31],[5836,-1202,13,32,32],[6996,-1044,24,24,33]]//sj-1 loopy lagoon
    ];
    ...
    public static int[][][] customDecals = [//x,y,w,h,bg/fg/sfg=0/1/2,decals/vinki/graffiti/(this index in decalNamespaces)(_x or _y depending on off/on status).png
        [[130,-510,1,1,0,0],[1760,524,1,1,1,1],[1412,279,1,1,1,2],[860,-1636,1,1,0,3],[896,-12,1,1,1,6],[111,1137,1,1,0,0]],//old site
        [[1268,28,1,1,0,9],[5660,-68,1,1,0,4],[3164,-556,1,1,0,5],[5664,297,1,1,0,7],[5992,-169,1,1,0,8]],//celestial resort
        ...
        [[684,1428,1,1,0,11],[1303,-385,1,1,0,15],[1528,1386,1,1,0,14]],//sj beginner lobby
        [[804,145,1,1,0,12],[2391,160,1,1,0,13],[3520,125,1,1,0,14]],//sj-1 seeing is believing
        [[228,105,1,1,0,15],[1835,-237,1,1,0,16],[5841,-1196,1,1,0,17],[7008,-1035,1,1,0,18]]//sj-1 loopy lagoon
    ];
